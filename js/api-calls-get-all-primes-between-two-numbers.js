$(document).ready(function () {
    ...
    $(".get-all-primes-between-two-numbers").submit(function (event) {
        ...
        let get_all_primes_between_two_numbers_apiKey = $("#get-all-primes-between-two-numbers-apiKey").val();
        let get_all_primes_between_two_numbers_check_start = $("#get-all-primes-between-two-numbers-start").val();
        let get_all_primes_between_two_numbers_check_end = $("#get-all-primes-between-two-numbers-end").val();
        let get_all_primes_between_two_numbers_include_explanations = $("#get-all-primes-between-two-numbers-include-explanations").val();
        let get_all_primes_between_two_numbers_include_prime_types_list = $("#get-all-primes-between-two-numbers-include-prime-types-list").val();
        let get_all_primes_between_two_numbers_language = $("#get-all-primes-between-two-numbers-language").val();
    ...
    function get_all_primes_between_two_numbers_api_call(get_all_primes_between_two_numbers_apiKey, get_all_primes_between_two_numbers_check_start, get_all_primes_between_two_numbers_check_end, get_all_primes_between_two_numbers_include_explanations, get_all_primes_between_two_numbers_include_prime_types_list, get_all_primes_between_two_numbers_language) {
        ...
        $.ajax({
            ...
            error: function(XMLHttpRequest, textStatus, errorThrown) {
                ...
                displayError(XMLHttpRequest.responseJSON.error, "error-get-all-primes-between-two-numbers")
            }
        });
    };
})
